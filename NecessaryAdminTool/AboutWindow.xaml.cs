...
namespace NecessaryAdminTool
{
    ...
    public partial class AboutWindow : Window
    {
        ...
        {
            InitializeComponent();
            Title = $"About {LogoConfig.PRODUCT_FULL_NAME}";
            LoadVersionInfo();
        }
        ...
        private void BtnCopyPorts_Click(object sender, MouseButtonEventArgs e)
        {
            try
            {
                ...
                sb.AppendLine($"{LogoConfig.PRODUCT_NAME} — Network Ports & Requirements");
        ...
        */ // END COMMENTED OUT - CreateShortcut_Click
        ...
        private void ExportLegalTerms_Click(object sender, MouseButtonEventArgs e)
        {
            try
            {
                ...
                string tempPath = Path.Combine(Path.GetTempPath(), $"{LogoConfig.PRODUCT_NAME}_Legal_Terms_{DateTime.Now:yyyyMMdd_HHmmss}.html");
...
<head>
    ...
    <title>{LogoConfig.PRODUCT_FULL_NAME} - End-User License Agreement</title>
    <style>
        * {{
            margin: 0;
            padding: 0;
...
<body>
    <div class=""container"">
        <div class=""header"">
            ...
            <div class=""brand"">{LogoConfig.COPYRIGHT_HOLDER}</div>
        ...
        <div class=""footer"">
            ...
            {LogoConfig.PRODUCT_FULL_NAME} v{version.Major}.{version.Minor} | {LogoConfig.COPYRIGHT_HOLDER} - All Rights Reserved | Confidential &amp; Proprietary<br>
        ...
        private string GetLegalContentHTML()
        {
            ...
            <p>This software product, {LogoConfig.PRODUCT_FULL_NAME} (""Software""), is licensed, not sold, to you by {LogoConfig.COPYRIGHT_HOLDER} (""Licensor"") for use strictly in accordance with the terms of this Agreement. This license grants you the right to install and use the Software solely for internal business operations within your organization's authorized IT infrastructure management activities.</p>
            ...
            <ul>
                ...
                <li>Transfer, sublicense, or assign your rights under this license to any third party without prior written consent from {LogoConfig.COPYRIGHT_HOLDER};</li>
            ...
            <p>The Software is protected by copyright laws and international copyright treaties, as well as other intellectual property laws and treaties. {LogoConfig.COPYRIGHT_HOLDER} retains all rights, title, and interest in and to the Software, including all copyrights, patents, trade secrets, trademarks, and other intellectual property rights therein. This Agreement does not grant you any rights to trademarks, service marks, or trade names of {LogoConfig.COPYRIGHT_HOLDER}.</p>

            <h2>4. CONFIDENTIALITY</h2>
            <p>The Software contains proprietary and confidential information of {LogoConfig.COPYRIGHT_HOLDER}. You agree to maintain the confidentiality of the Software and to not disclose, provide, or otherwise make available such proprietary and confidential information to any third party without the prior written consent of {LogoConfig.COPYRIGHT_HOLDER}.</p>
            ...
            <h2>7. TERMINATION</h2>
            <p>This license is effective until terminated. Your rights under this license will terminate automatically without notice from {LogoConfig.COPYRIGHT_HOLDER} if you fail to comply with any term(s) of this Agreement. Upon termination, you shall cease all use of the Software and destroy all copies, full or partial, of the Software.</p>

            <h2>8. COMMERCIAL USE PROHIBITION</h2>
            <p>This Software is licensed exclusively for use within the internal operations of the organization to which it has been provided. Any commercial use, resale, redistribution, or deployment of this Software for third-party benefit or monetary gain is strictly prohibited without a separate commercial licensing agreement with {LogoConfig.COPYRIGHT_HOLDER}.</p>

            <h2>9. GOVERNING LAW</h2>
            <p>This Agreement shall be governed by and construed in accordance with the laws of the jurisdiction in which {LogoConfig.COPYRIGHT_HOLDER} operates, without regard to its conflict of law provisions.</p>

            <h2>10. ENTIRE AGREEMENT</h2>
            <p>This Agreement constitutes the entire agreement between you and {LogoConfig.COPYRIGHT_HOLDER} concerning the Software and supersedes all prior or contemporaneous oral or written communications, proposals, and representations with respect to the Software or any other subject matter covered by this Agreement.</p>

            <h2>11. DATA PRIVACY &amp; SECURITY POLICY</h2>
            <p>The Software may collect, process, and store system information, performance metrics, audit logs, and user authentication data necessary for its operation. By using this Software, you acknowledge and consent to such data collection strictly for the purposes of system management, diagnostic logging, and security auditing. {LogoConfig.COPYRIGHT_HOLDER} commits to maintaining the confidentiality and security of collected data in accordance with applicable data protection regulations. No personally identifiable information (PII) or sensitive business data will be transmitted to external servers without explicit user consent. All authentication credentials are encrypted and stored locally using industry-standard cryptographic methods (AES-256, SecureString, and RtlSecureZeroMemory).</p>
            ...
            <p>{LogoConfig.COPYRIGHT_HOLDER} is not liable for any security breaches, data loss, or unauthorized access resulting from improper configuration, weak authentication, or misuse of the Software.</p>

            <h2>13. AUDIT &amp; COMPLIANCE OBLIGATIONS</h2>
            <p>The Software maintains comprehensive audit logs of all administrative actions, system modifications, remote access sessions, and deployment activities. You are responsible for retaining these logs in accordance with your organization's data retention policies and applicable regulatory requirements (including but not limited to SOX, HIPAA, PCI-DSS, GDPR, and other industry-specific compliance frameworks). {LogoConfig.COPYRIGHT_HOLDER} reserves the right to audit your use of the Software to ensure compliance with this Agreement. You agree to provide reasonable cooperation and access to records upon request for compliance verification purposes.</p>

            <h2>14. SOFTWARE UPDATES &amp; MAINTENANCE</h2>
            <p>{LogoConfig.COPYRIGHT_HOLDER} may, at its sole discretion, provide updates, patches, bug fixes, or new versions of the Software. You acknowledge that updates may modify, add, or remove features without prior notice. Installation of updates is recommended but not mandatory unless critical security vulnerabilities are addressed. {LogoConfig.COPYRIGHT_HOLDER} is under no obligation to provide updates, technical support, or maintenance services unless otherwise specified in a separate support agreement. Failure to install critical security updates may result in security vulnerabilities for which {LogoConfig.COPYRIGHT_HOLDER} shall not be held liable.</p>
            ...
            <p>The Software is designed to operate on Windows 10/11 systems with .NET Framework 4.8.1 or later, in Active Directory domain environments. Minimum system requirements include: 4-core processor, 8GB RAM, network connectivity, and administrator privileges. {LogoConfig.COPYRIGHT_HOLDER} makes no warranty that the Software will function correctly on systems not meeting these requirements or in non-domain environments. Performance may vary based on network topology, domain size, hardware specifications, and configuration settings. {LogoConfig.COPYRIGHT_HOLDER} is not responsible for compatibility issues with third-party security software, group policies, or custom system configurations that interfere with Software operation.</p>

            <h2>21. TELEMETRY &amp; DIAGNOSTIC DATA</h2>
            <p>The Software may collect anonymous telemetry and diagnostic data including error reports, performance metrics, feature usage statistics, and system configuration information to improve product quality and user experience. All telemetry data is anonymized and does not include personally identifiable information, credentials, or sensitive business data. You may disable telemetry collection through the Software's configuration settings, though this may impact the quality of support services. {LogoConfig.COPYRIGHT_HOLDER} uses collected data solely for product improvement, bug fixes, and feature development purposes.</p>

            <h2>22. INTELLECTUAL PROPERTY CLAIMS</h2>
            <p>If you believe that the Software infringes upon any patent, copyright, trademark, or other intellectual property right, you must promptly notify {LogoConfig.COPYRIGHT_HOLDER} in writing with detailed information regarding the alleged infringement. {LogoConfig.COPYRIGHT_HOLDER} reserves the right to modify or replace allegedly infringing components, obtain necessary licenses, or terminate this Agreement at its sole discretion. This section constitutes your sole and exclusive remedy for any intellectual property infringement claims related to the Software.</p>

            <h2>23. FORCE MAJEURE</h2>
            <p>{LogoConfig.COPYRIGHT_HOLDER} shall not be liable for any failure or delay in performance of its obligations under this Agreement due to causes beyond its reasonable control, including but not limited to: acts of God, war, terrorism, civil unrest, labor disputes, natural disasters, government actions, pandemics, epidemics, cyber-attacks, power failures, telecommunications failures, or other unforeseeable circumstances. In such events, {LogoConfig.COPYRIGHT_HOLDER}'s obligations shall be suspended for the duration of the force majeure event.</p>

            <h2>24. SEVERABILITY &amp; WAIVER</h2>
            <p>If any provision of this Agreement is found to be invalid, illegal, or unenforceable by a court of competent jurisdiction, the remaining provisions shall continue in full force and effect. The invalid provision shall be modified to the minimum extent necessary to make it valid and enforceable while preserving the original intent. No waiver of any breach of this Agreement shall constitute a waiver of any subsequent breach. Failure by {LogoConfig.COPYRIGHT_HOLDER} to enforce any provision of this Agreement shall not be construed as a waiver of that or any other provision.</p>

            <h2>25. AMENDMENT &amp; MODIFICATION RIGHTS</h2>
            <p>{LogoConfig.COPYRIGHT_HOLDER} reserves the right to modify, amend, or update this Agreement at any time without prior notice. Continued use of the Software following any such modifications constitutes your acceptance of the revised terms. Material changes to this Agreement will be communicated through the Software interface, email notification, or posted to the {LogoConfig.COPYRIGHT_HOLDER} website. It is your responsibility to review this Agreement periodically for changes. If you do not agree to modified terms, you must immediately cease using the Software and uninstall it from all systems.</p>

            <h2>26. DISPUTE RESOLUTION &amp; ARBITRATION</h2>
            <p>Any disputes, claims, or controversies arising out of or relating to this Agreement or the Software shall first be subject to good-faith negotiation between the parties. If negotiation fails to resolve the dispute within thirty (30) days, the dispute shall be resolved through binding arbitration in accordance with the rules of the American Arbitration Association. The arbitration shall be conducted in the jurisdiction where {LogoConfig.COPYRIGHT_HOLDER} is headquartered. Each party shall bear its own costs and expenses related to arbitration. The arbitrator's decision shall be final and binding, and judgment may be entered in any court of competent jurisdiction. Notwithstanding the foregoing, either party may seek injunctive or other equitable relief in court to prevent irreparable harm or protect intellectual property rights.</p>

            <h2>27. SURVIVAL OF TERMS</h2>
            <p>The following sections shall survive termination or expiration of this Agreement: Proprietary Rights, Confidentiality, Warranty Disclaimer, Limitation of Liability, Indemnification, Governing Law, Dispute Resolution, and any other provisions which by their nature are intended to survive termination. Upon termination, you must immediately cease all use of the Software, destroy all copies, and certify in writing to {LogoConfig.COPYRIGHT_HOLDER} that you have complied with these obligations.</p>
            ...
            <ul>
                ...
                <li>You acknowledge that this Agreement constitutes a binding legal contract between you (individually and/or on behalf of your organization) and {LogoConfig.COPYRIGHT_HOLDER}.</li>
            </ul>
