...
";
        ...
        private void ExportLegalTerms_Click(object sender, MouseButtonEventArgs e)
        {
            try
            {
                ...
                string tempPath = Path.Combine(Path.GetTempPath(), $"ArtaznIT_Legal_Terms_{DateTime.Now:yyyyMMdd_HHmmss}.html");
...
<head>
    ...
    <title>ArtaznIT Suite - End-User License Agreement</title>
    <style>
        * {{
            margin: 0;
            padding: 0;
...
<body>
    <div class=""container"">
        ...
        <div class=""footer"">
            ...
            ArtaznIT Suite v{version.Major}.{version.Minor} | Artazn LLC - All Rights Reserved | Confidential &amp; Proprietary<br>
